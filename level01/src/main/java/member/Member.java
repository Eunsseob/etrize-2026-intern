...
public class Member {
	...
	public String toString() {
		return "Member [userId=" + userId + ", userPw=" + userPw + ", userName=" + userName + ", userPhone1="
				+ userPhone1 + ", userPhone2=" + userPhone2 + ", userPhone3=" + userPhone3 + ", userAddr1=" + userAddr1
				+ ", userAddr2=" + userAddr2 + ", userCompany=" + userCompany + ", creator=" + creator + ", creatTime="
				+ creatTime + ", modifier=" + modifier + ", modifiedTime=" + modifiedTime + "]";
	}
}
